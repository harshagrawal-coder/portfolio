...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* content */}
      <div className="relative container z-10 mx-auto px-6 pt-20 ">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-300">
                Hi, I'm Harsh Agrawal — a software engineer specializing in
                React,Express.js ,Node.js and MongoDb. I build scalable,
